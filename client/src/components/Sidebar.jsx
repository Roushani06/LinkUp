...
useEffect(()=>{
  ...
  return (
    <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? "max-md:hidded" : ''}`}>
      <div className= 'pb-5'>
        <div className= 'flex justify-between items-center'>
            <div className='flex items-center gap-2'>
      <img src={assets.logo_icon} alt="logo" className='max-w-8'/>
      <h2 className='text-white text-lg font-semibold'>LinkUp</h2>
    </div>
