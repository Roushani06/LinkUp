...
const ProfilePage = () => {
  ...
  const [bio, setBio] = useState("Hi everyone, I am using LinkUp!")
  ...
  return (
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      ...
      border-gray-600 flex items-center justify-baseline max-sm:flex-col-reverse rounded lg'>
        ...
        <img className='max-w-44 aspect-sqauare rounded-full mx-10 max-sm:mt-10'
